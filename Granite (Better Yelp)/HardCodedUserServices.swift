...
//        
//        create(user.username, user.email, user.fullName, user.password, user.userBio)
//        
//    }
//    
//    private static func create(_ username: String, _ email: String, _ fullName: String, _ password: String, _ userBio: String) {
//        let user = HardCodedUsers(username: username, email: email , fullName: fullName, password: password, userBio: userBio)
