...
class HardCodedUsers: NSObject {
    ...
    init(username: String, email:String, fullName: String, password:String, githubName: String) {
    ...
    var dictValue: [String: Any] {
        return["username": username, "email": email, "fullName": fullName, "password": password, "githubName": githubName]
